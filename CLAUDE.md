...
**Repository:** `ignition-module-python3` - Production-ready v3.5.4
...
**Current Version: v3.5.4** (February 2026)
...
**Recent Releases:**
- v3.5.4 (Feb 2026) - Designer Script Console fix, Project Browser auth & folder creation
