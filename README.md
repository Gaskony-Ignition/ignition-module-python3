...
<!-- Version and Status -->
![Version](https://img.shields.io/badge/version-2.15.2-blue.svg)
...
**🎯 Repository:** Java Swing IDE (Stable) | **Version:** v2.15.2 | **Module ID:** `com.gaskony.python3integration.swing`
...
- **This repository:** Stable Java Swing IDE (v2.15.2) - Production-ready
